...
| ------------------------------------------ | ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Current T3 Code base                       | Proven                    | `git rev-list --left-right --count upstream/main...HEAD` returns `0 13` for the H15 candidate after the latest rebase.                                                                                                                             |
...
| Backup/rollback/deployment safety          | Proven locally            | Shell/plist validation, online SQLite backup integrity/restore, immutable release layout, isolated Serve staging, loopback binding, health probes, and fresh-directory rollback are documented and exercised locally.                              |
