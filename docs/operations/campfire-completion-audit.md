...
| ------------------------------------------ | ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Current T3 Code base                       | Proven                    | `git rev-list --left-right --count upstream/main...HEAD` returns `0 16` for the H18 evidence commit; the standalone runtime artifact was rebuilt from rebased H17 immediately before this record.                                                                                  |
