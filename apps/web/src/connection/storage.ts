...
// v3 stores the snapshot sequence alongside the thread and invalidates v2
// entries that may have missed side-thread events before those events were
// included in detailed-thread subscriptions. It can still resume via
// `afterSequence` instead of re-downloading the full thread body.
