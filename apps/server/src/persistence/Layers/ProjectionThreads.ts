...
import { CollaborationUser, ModelSelection, SideThread } from "@t3tools/contracts";
    ...
    execute: (row) =>
      sql`
        ...
        DO UPDATE SET
          ...
          kind = excluded.kind,
          review_pull_request_number = excluded.review_pull_request_number,
