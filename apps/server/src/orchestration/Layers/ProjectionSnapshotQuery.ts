...
const ProjectionProjectDbRowSchema = ProjectionProject.mapFields(
  Struct.assign({
    ...
    defaultReviewModelSelection: Schema.NullOr(Schema.fromJsonString(ModelSelection)),
...
function mapProjectShellRow(
  ...
  return {
    ...
    defaultReviewModelSelection: row.defaultReviewModelSelection,
    scripts: row.scripts,
    ...
    execute: () =>
      sql`
        SELECT
          ...
          kind,
          review_pull_request_number AS "reviewPullRequestNumber",
          branch,
          ...
          ([
            ...
            Effect.gen(function* () {
              ...
              const threads: ReadonlyArray<OrchestrationThread> = threadRows.map((row) => ({
                ...
                kind: row.kind,
                reviewPullRequestNumber: row.reviewPullRequestNumber,
                branch: row.branch,
            ...
            : repositoryIdentityResolver.resolve(option.value.workspaceRoot).pipe(
                Effect.map((repositoryIdentity) =>
                  Option.some({
                    ...
                    defaultReviewModelSelection: option.value.defaultReviewModelSelection,
  ...
  const getThreadShellById: ProjectionSnapshotQueryShape["getThreadShellById"] = (threadId) =>
    Effect.gen(function* () {
      ...
      return Option.some({
        ...
        reviewPullRequestNumber: threadRow.value.reviewPullRequestNumber,
